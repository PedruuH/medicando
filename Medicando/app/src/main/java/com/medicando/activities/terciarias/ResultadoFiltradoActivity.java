package com.medicando.activities.terciarias;
...
import com.medicando.activities.EfetuarCompraActivity;
import com.medicando.activities.OutraOpcoesActivity;
import com.medicando.controller.ProdutoFinalController;
import com.medicando.datamodel.mDescricaoDataModel;
...
import com.medicando.util.UtilProdutoFinal;
...
public class ResultadoFiltradoActivity extends AppCompatActivity {
    ...
    public void showQuantasVezesDialog(View view){
        ...
        v.findViewById(R.id.btnConfirmarNumberPicker).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                UtilMedicando.showToastSucess(ResultadoFiltradoActivity.this,
...
//            task.execute();
//        } else {
//            UtilMedicando.showToastInfo(ResultadoFiltradoActivity.this, "Conecte-se a Internet para prosseguir-mos!");
//        }
    }
...
//        startActivityForResult(it, REQUEST_CODE);
    ...
    public void adicionarCesta(View view) {
        UtilMedicando.showToastInfo(ResultadoFiltradoActivity.this, "Adicionar a cesta será implementado na próxima versão!");
    }
}
