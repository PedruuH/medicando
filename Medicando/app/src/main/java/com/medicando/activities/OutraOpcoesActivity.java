...
import com.medicando.adapter.AdapterOutrasOpcoes;
import com.medicando.datamodel.FarmaciasDataModel;
import com.medicando.datamodel.LinkServerDataModel;
import com.medicando.datamodel.PrecosDataModel;
import com.medicando.datamodel.VerificacoesWebService;
import com.medicando.datamodel.mDescricaoDataModel;
import com.medicando.model.OutrasOpcoes;
...
public class OutraOpcoesActivity extends AppCompatActivity {
    ...
    public class BuscarOutrasOpcoesAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL(UtilMedicando.URL_WEB_SERVICE + LinkServerDataModel.getAPIBuscarOutrasOpcoes());
