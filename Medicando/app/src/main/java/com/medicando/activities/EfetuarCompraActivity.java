package com.medicando.activities;
...
import com.medicando.fragments.ConfirmaPedidoFragment;
import com.medicando.fragments.FotoReceitaFragment;
import com.medicando.fragments.VerificaEnderecoFragment;
import com.medicando.fragments.VerificaFormaPagamentoFragment;
import com.medicando.helper.GeradorIdPedidos;
import com.medicando.helper.UsuarioPreferences;
import com.medicando.model.Bancarios;
import com.medicando.model.Endereco;
import com.medicando.model.Pedidos;
import com.medicando.model.ProdutoFinal;
import com.medicando.util.UtilMedicando;
import com.medicando.util.UtilPedidos;
...
public class EfetuarCompraActivity extends AppCompatActivity
        ...
        switch(mostrarLayout){
            case 1:
                if(pedido.getPedIdUserEndereco() != 0){
                    ...
                    UtilMedicando.showToastInfo(EfetuarCompraActivity.this, "É necessário escolher um endereço!");
                }
                break;
            case 2:
                if(pedido.getPedIdUserBancarios() != 0 && precisaReceita.equals("S")){
                    ...
                    UtilMedicando.showToastInfo(EfetuarCompraActivity.this, "É necessário escolher uma forma de pagamento!");
                }
                break;
            case 3:
                if(adicionouFoto == 1){
                    ...
                    UtilMedicando.showToastInfo(EfetuarCompraActivity.this, "Adicione uma Foto!");
                } else {
                    UtilMedicando.showToastInfo(EfetuarCompraActivity.this, "Aguarde o processamento da Foto");
                }
    ...
    public void setUrlLink(String urlLink) {
        ...
        adicionouFoto = 1;
        UtilMedicando.showToastSucess(EfetuarCompraActivity.this, "Podemos prosseguir com a compra");
    }
