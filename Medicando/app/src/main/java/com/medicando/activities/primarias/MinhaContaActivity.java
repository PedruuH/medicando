...
import com.medicando.activities.secundarias.AdicionarEnderecoActivity;
import com.medicando.activities.secundarias.AdicionarFormaPgmtActivity;
import com.medicando.adapter.AdapterEndereco;
import com.medicando.adapter.AdapterFormaPgmt;
import com.medicando.datamodel.LinkServerDataModel;
import com.medicando.datamodel.UsuarioDataModel;
    ...
    public AdapterEndereco.EnderecoOnClickListener enderecoOnClickListener() {
        return new AdapterEndereco.EnderecoOnClickListener() {
            ...
            public void formaPgmtOnClick(AdapterEndereco.HolderEndereco holder, int position) {
                ...
                UtilMedicando.showToastInfo(MinhaContaActivity.this, "Editar será implementado na próxima versão!");
            }
        };
    }
...
//                url = new URL(UtilMedicando.URL_WEB_SERVICE + LinkServerDataModel.getAPIBuscarDadosEspecificos());
...
//                }
//            }
            textNome.setText("Usuário de Teste");
            textEmail.setText("teste@email.com");
            textCadastro.setText("17/03/2019");
            if(pbMinhaConta != null && pbMinhaConta.getVisibility() == VISIBLE){
                pbMinhaConta.setVisibility(View.INVISIBLE);
            }
            ...
            endereco = new Endereco();
            endereco.setEndLogradouro("Rua Teste");
            endereco.setEndNumero("100");
            endereco.setEndBairro("Bairro Teste");
            endereco.setEndCidade("Uberlândia");
            enderecoList.add(endereco);

            adapterEndereco.notifyDataSetChanged();

            bancarios = new Bancarios();
            bancarios.setBanIdBandeira(5);
            bancarios.setBanNumero("4163");
            bancariosList.add(bancarios);
