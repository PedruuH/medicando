...
import com.medicando.fragments.CadastraEnderecoFragment;
...
public class UtilEndereco {
    public static class procurarEnderecoViaCEP extends AsyncTask<String, String, String>{
        ...
        public procurarEnderecoViaCEP(AppCompatActivity context, ProgressBar progressBar, String cep){
            ...
            UtilMedicando.setUrlWebServiceViacep(cep);
        }
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                url = new URL(UtilMedicando.getUrlWebServiceViacep());
        ...
        protected void onPostExecute(String resultado) {
            try {
                ...
                if(object.getBoolean("erro")){
                    UtilMedicando.showToastShort(context.getApplicationContext(), "Verifique os dados inseridos!");
    ...
    public static class cadastrarEnderecoUsuario extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL(UtilMedicando.URL_WEB_SERVICE + LinkServerDataModel.getAPICadastrarEnderecoUsuario());
            } catch (MalformedURLException e) {
                UtilMedicando.showToastShort(context, "Houve erro! Servidor incorreto.");
            } catch (Exception e) {
                UtilMedicando.showToastShort(context, "Houve erro! Tente novamente mais tarde.");
        ...
        protected void onPostExecute(String result) {
            ...
            if(progressBar != null && progressBar.getVisibility() == VISIBLE){
                progressBar.setVisibility(View.INVISIBLE);
                UtilMedicando.showToastSucess(context, "Endereço cadastrado com Sucesso!");
            }
        }
    }
}
