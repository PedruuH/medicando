...
import com.medicando.helper.Criptografia64;
    ...
    public static class InsertUsuarioAsyncTask extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                url = new URL(UtilMedicando.URL_WEB_SERVICE + LinkServerDataModel.getAPICadastrarUsuario());
        ...
        protected void onPostExecute(String result) {
            ...
            try{
                ...
                if(idUser != 0){
                    ...
                    UtilMedicando.showToastError(context, "Não foi possível cadastrar! Tente novamente mais tarde.");
                }
            } catch (Exception e){
                UtilMedicando.showToastError(context, "Não foi possível cadastrar! Tente novamente mais tarde.");
            }
...
//            builder.appendQueryParameter("password", usuario.getSenhaUser());
        ...
        protected String doInBackground(String... strings) {
//            try {
//                url = new URL(UtilMedicando.URL_WEB_SERVICE + LinkServerDataModel.getAPIBuscarDadosLogin());
//                Log.d("WebService", "onPostExecute: " + UtilMedicando.URL_WEB_SERVICE + LinkServerDataModel.getAPIBuscarDadosLogin());
//            } catch (MalformedURLException e) {
//                UtilMedicando.showToastShort(context, "Houve erro! Servidor incorreto.");
//            } catch (Exception e) {
//                UtilMedicando.showToastShort(context, "Houve erro! Tente novamente mais tarde.");
