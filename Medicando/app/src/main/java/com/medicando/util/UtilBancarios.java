...
import com.medicando.datamodel.BancariosDataModel;
...
public class UtilBancarios {
    public static class cadastrarFormaPgmtUsuario extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL(UtilMedicando.URL_WEB_SERVICE + LinkServerDataModel.getAPICadastrarFormaPgmt());
        ...
        protected void onPostExecute(String result) {
            ...
            if(progressBar != null && progressBar.getVisibility() == VISIBLE){
                ...
                UtilMedicando.showToastSucess(context, "Forma de pagamento cadastrado com Sucesso!");
            }
        }
    }
}
