...
import com.medicando.activities.introducao.IntrodutorioActivity;
import com.medicando.activities.primarias.MainActivity;
import com.medicando.controller.BuscasController;
...
import com.medicando.model.Buscas;
...
public class UtilBuscas {
    public static class BuscarNomeMedicamentoAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL(UtilMedicando.URL_WEB_SERVICE + LinkServerDataModel.getAPIBuscarMedicamentos());
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                UtilMedicando.showToastInfo(context, "Servidor Indisponível");
            } finally {
...
//                        controller.salvar(busca);
                    ...
                    UtilMedicando.showToastSucess(context, "Foi atualizado com Sucesso!");
                }
